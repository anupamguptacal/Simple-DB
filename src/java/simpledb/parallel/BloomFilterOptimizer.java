...
public class BloomFilterOptimizer extends ParallelQueryPlanOptimizer {
    ...
    private OpIterator doInsertBloomFilter(TransactionId tid, OpIterator root,
        ...
        if (rootO instanceof Join || rootO instanceof HashEquiJoin) {
            ...
            if (bloomFilterToInsert != null) {
                bloomFilterToInsert
                        .setChildren(new OpIterator[] { doInsertBloomFilter(tid,
                                children[0], null) });
                rootO.setChildren(new OpIterator[] { bloomFilterToInsert });
                return rootO;
            }
        }
