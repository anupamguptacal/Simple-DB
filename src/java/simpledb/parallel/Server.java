...
//                e.printStackTrace();
    ...
    protected void dispatchWorkerQueryPlans(
            HashMap<SocketInfo, OpIterator> plans) {
        for (Map.Entry<SocketInfo, OpIterator> e : plans.entrySet()) {
            SocketInfo worker = e.getKey();
            OpIterator plan = e.getValue();
    ...
    protected void startQuery(ParallelQueryPlan queryPlan,
        ...
        HashMap<SocketInfo, OpIterator> workerPlans = new HashMap<SocketInfo, OpIterator>();
    ...
    protected void processQuery(Query q) throws DbException,
        ...
        OpIterator sequentialQueryPlan = q.getPhysicalPlan();
